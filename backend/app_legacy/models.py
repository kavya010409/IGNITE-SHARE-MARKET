...
# Table 2: Stock Master Catalog
class Stock(Base):
    __tablename__ = "stocks"

    id: Mapped[int] = mapped_column(primary_key=True, autoincrement=True)
    ticker: Mapped[str] = mapped_column(String(4), unique=True, index=True, nullable=False)
...
# Table 3: Stock History Time-Series
...
# Table 4: Portfolio Holdings Ledger
...
# Table 5: Transaction Order Ledger
...
# Table 6: Admin News Logs (Delayed Volatility Multipliers)
class NewsLog(Base):
